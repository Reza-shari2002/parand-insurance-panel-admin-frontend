...
import Modal_send_notification_holder from "../modal_send_notification/modal_send_notification_holder";
...
function Userdetail_holder() {
  ...
  return (
    <div className="min-h-screen space-y-10 bg-gray-50 p-4 md:p-8" dir="rtl">
      {/* بخش اول: اطلاعات پایه و متنی */}
      <section>
        <div className="mb-4 flex items-center justify-between gap-3 border-r-4 border-orange-500 pr-3">
          <h2 className="text-xl font-bold text-gray-800">اطلاعات پایه کاربر</h2>

          <Modal_send_notification_holder
      ...
      <section>
        <div className="mb-4 flex items-center gap-2 border-r-4 border-blue-600 pr-3">
